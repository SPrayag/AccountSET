...
public class AccountServiceTest {
	...
	private final Account ACCOUNT_1 = new Account("ABC123", "AVA", "GARDNER");
	private final Account ACCOUNT_2 = new Account("XYZ456", "GENE", "KELLY");
	private final Account ACCOUNT_3 = new Account("DEF987", "MARLON", "BRANDO");
	private final Account ACCOUNT_4 = new Account("GHI654", "HEDY", "LAMARR");
